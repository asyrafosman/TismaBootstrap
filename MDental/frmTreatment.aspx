<%@ Page Title="" Language="C#" MasterPageFile="~/boardMain.master" AutoEventWireup="true" CodeFile="frmTreatment.aspx.cs" Inherits="Dental_Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <br />
         <ul class="nav nav-tabs" >
             ...
             <li class="active"><a href="frmTreatment.aspx">Treatment</a></li>
